...
def bbox2mask(FLAGS, bbox, name='mask'):
    ...
    def npmask(bbox, height, width, delta_h, delta_w):
        ...
        w = np.random.randint(delta_w//2+1) #; import pdb; pdb.set_trace()
...
def contextual_attention(f, b, mask=None, ksize=3, stride=1, rate=1, FLAGS=None, 
    ...
    # to flow image
    flow = flow_to_image_tf(offsets, FLAGS=FLAGS)
...
def test_contextual_attention(args):
    ...
    with tf.Session() as sess:
        ...
        yt, flow = contextual_attention(
            ft, bt, stride=stride, rate=rate, FLAGS=FLAGS,
...
def make_color_wheel():
    ...
    return colorwheel # np.repeat(colorwheel, 4, axis=1) #colorwheel # [:, 0].reshape([ncols, 1])
...
def flow_to_image_tf(flow, FLAGS=None, name='flow_to_image'):
